...
.yext-family-destination-header p,
.yext-family-destination-header li {
...
.yext-family-destination-header h1 {
...
.yext-family-destination-header h2 {
...
.yext-family-destination-header h3 {
...
.yext-family-destination-header h4 {
...
.yext-family-destination-header h5 {
...
.yext-family-destination-header h6 {
...
:where(.yext-family-destination-header) a {
...
type FamilyDestinationHeaderProps = {
...
const FamilyDestinationHeaderFields: YextFields<FamilyDestinationHeaderProps> =
  {
    variant: {
      label: "Variant",
      type: "select",
          ...
          defaultItemProps: {
            cta: {
              ...
              styles: {
                ...
                link: { ...defaultLinkStyles, includeCaret: "none" },
              },
            },
          },
          getItemSummary: (
...
const FamilyDestinationHeaderComponent: PuckComponent<
  FamilyDestinationHeaderProps
> = (props) => {
  ...
  return (
    ...
    >
      <Background
        ...
        className="yext-family-destination-header relative"
        style={{
          ...headerSurfaceStyle,
            ...
            <div className="hidden items-center gap-3 md:flex">
              ...
              >
                <ComprehensiveCTA
                  ...
                  className={
                    topBarCtaItem.cta.styles?.variant === "link"
                      ? "inline-flex min-h-12 w-max max-w-full items-center self-start border-b border-current py-4 text-base font-bold leading-5 tracking-[0.16px] no-underline transition-colors hover:text-[var(--colors-palette-tertiary)] focus-visible:text-[var(--colors-palette-tertiary)]"
                      : "inline-flex h-10 items-center justify-center px-5 transition-opacity hover:opacity-90"
                  }
                />
...
export const FamilyDestinationHeader: YextComponentConfig<FamilyDestinationHeaderProps> =
  {
        ...
        items: [
          {
            cta: {
              data: {
                ...
                openInNewTab: false,
                buttonText: { defaultValue: "Check Availability" },
                customId: "",
                customClass: "",
                dataAttributes: [],
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`FamilyDestinationHeader${getAnalyticsScopeHash(props.id)}`}
      >
        <FamilyDestinationHeaderComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };

export const config: SectionConfig = {
  id: "FamilyDestinationHeader",
  displayName: "Header",
  description: "Header",
